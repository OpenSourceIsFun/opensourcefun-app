...
import { API_KYC_ROUTE, MOBILE_KYC_ROUTE } from '@/constants/routes';
import fetchJson from '@/services/fetchJson';
import { KycStatusTypes } from '../KYCProvider/hooks/useKYCStatusState';
        ...
        <>
          ...
          <Flex flexDirection="column" marginTop="30px">
            ...
            >
              ...
              claim. Feel free to go to the launchpad.
            </Text>
            <Button variant="primary" width="158px">
              Ready to Lock
            </Button>
          </Flex>
        </>
      ...
      {isKYCBlocked && (
        <>
          ...
          <Text maxWidth={468}>
            ...
            via support@opensourcefun.network. We will respond as soon as possible.
            <br />
            <br />
